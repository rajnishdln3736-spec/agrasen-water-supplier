...
const ADMIN_USERNAME = "satish123@gmail.com";
const ADMIN_ALT_USER = "satish";
// SHA-256 hash of password '12345678'
const ADMIN_PASSWORD_HASH = "ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f"; 
  ...
  async fetch(request, env, ctx) {
    ...
    if (path === "/api/admin/login" && method === "POST") {
      try {
        ...
        const isPassMatch = passHash === ADMIN_PASSWORD_HASH || password === "12345678";
